  ...
  return (
    <>
      ...
      <section className="relative flex min-h-[88vh] items-end overflow-hidden">
        ...
        <div className="relative mx-auto w-full max-w-7xl px-4 pb-16 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            <Link
              href="/projects"
              className="rounded-full bg-brand-blue-500 px-7 py-3.5 font-semibold text-white transition-colors hover:bg-brand-blue-600"
            >
              Explore Projects
            </Link>
            <Link
              href="/contact"
              className="rounded-full border border-white/40 bg-white/10 px-7 py-3.5 font-semibold text-white backdrop-blur transition-colors hover:bg-white/20"
            >
              Book a Site Visit
            </Link>
          </div>
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {whyChooseUs.map((item) => (
            <div
              key={item.title}
              className="rounded-2xl border border-border bg-surface-raised p-6 shadow-sm transition-shadow hover:shadow-md"
            >
              <h3 className="font-heading text-lg font-semibold text-brand-blue-600">{item.title}</h3>
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {features.map((item) => (
            <div key={item.title} className="rounded-2xl bg-brand-blue-50 p-6">
              <h3 className="font-heading text-lg font-semibold text-brand-blue-700">{item.title}</h3>
              <p className="mt-2 text-sm leading-relaxed text-ink-muted">{item.description}</p>
            </div>
          ))}
        </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-3">
            {services.map((service) => (
              ...
              >
                <h3 className="font-heading text-lg font-semibold text-brand-crimson-500">
                  {service.title}
                </h3>
      ...
      <section className="bg-brand-crimson-500 py-16">
        <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <Link
            href="/contact"
            className="mt-8 inline-block rounded-full bg-white px-8 py-3.5 font-semibold text-brand-crimson-600 transition-colors hover:bg-white/90"
          >
            Book a Site Visit
          </Link>
        </div>
